    ...
    <div class="col-md-12">
        <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
                ...
                <li class="active">
                    <a data-toggle="tab" href="<?php echo Router::url('/', true); ?>departments/edit/<?= $department->id ?>">Edit Department</a>
                </li>
                <li>
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <label>Name</label>
                            <input name="name" class="form-control" type="text" value="<?= $department->name; ?>">
                        </div>
