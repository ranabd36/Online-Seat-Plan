    ...
    <div class="col-md-12">
        <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
                ...
                <li class="active">
                    <a data-toggle="tab" href="<?php echo Router::url('/', true); ?>schedules/edit<?= $schedule->id ?>">Edit Schedule</a>
                </li>
            ...
            <div class="tab-content" style="min-height:460px">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <input class="form-control" id="datepicker" name="date" required="required" type="text" value="<?= $schedule->date ?>">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="section" name="section_id" required="required">
                                <option value="<?= $schedule->section->id ?>"><?= $schedule->section->name ?></option>
                            </select>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="column" name="column_id" required="required">
                                <option value="<?= $schedule->column_id ?>"><?= $schedule->column_id ?></option>
                            </select>
                        </div>
